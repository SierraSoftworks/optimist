...
.node-relationship-menu-heading small { color: var(--muted); font-size: var(--text-2xs); }
.node-relationship-menu-heading strong { max-width: 220px; overflow: hidden; color: var(--ink); font-size: var(--text-xs); text-overflow: ellipsis; white-space: nowrap; }
.node-relationship-menu > button { width: 100%; padding: 7px 10px 7px 34px; border: 0; background: transparent; color: var(--ink); font-size: var(--text-xs); text-align: left; }
