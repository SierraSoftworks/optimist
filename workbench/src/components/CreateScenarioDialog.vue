...
<style scoped>
.scenario-dialog { width: min(640px, 100%); max-height: calc(100vh - 32px); overflow: auto; }
.scenario-options { margin-top: 16px !important; padding-top: 12px !important; border-top: 1px solid var(--line) !important; }
...
@media (max-width: 760px) {
  .scenario-dialog { max-height: calc(100svh - 24px); }
}
</style>
