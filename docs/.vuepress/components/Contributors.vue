<template>
    <div v-if="hasContributors">
        ...
        <p>
            Thank you to everyone who has contributed to turning Optimist into the tool you find here. If your name is
            missing from the list, please open an issue and we'll get it resolved as quickly as we can.
        </p>
