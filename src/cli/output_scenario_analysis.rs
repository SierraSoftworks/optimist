...
fn table(analysis: &ScenarioAnalysis) -> String {
    let header = "INTERVENTION\tOUTCOME\tREACHABLE\tDIRECTION\tIMPORTANCE\tBASELINE_MEAN\tFINAL_MEAN\tIMPROVEMENT_MEAN\tIMPROVEMENT_VARIANCE\tCLAMPED_UPDATES\tSAMPLES\tSTATUS";
